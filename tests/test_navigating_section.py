...
def test_navigate_to_buns_section(driver):
    ...
    assert buns_header.is_displayed(), "Переход к разделу Булки"
...
def test_navigate_to_sauces_section(driver):
    ...
    assert buns_header.is_displayed(), "Переход к разделу Соусы"
...
def test_navigate_to_fillings_section(driver):
    ...
    assert buns_header.is_displayed(), "Переход к разделу Начинки"
